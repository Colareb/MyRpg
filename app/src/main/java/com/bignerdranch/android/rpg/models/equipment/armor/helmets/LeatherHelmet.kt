package com.bignerdranch.android.rpg.models.equipment.armor.helmets
...
class LeatherHelmet: Armor(R.string.leather_helmet_name, R.string.leather_helmet_description, Elements.NORMAL, EquipmentParts.HELMET,1) {
